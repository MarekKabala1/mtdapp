...
export const businessDetails = sqliteTable("business_details", {
  ...
  accountingType: text("accounting_type", {
    enum: ["CASH", "ACCRUALS"],
  }).default("CASH"),
  last_synced_at: integer("last_synced_at", { mode: "timestamp" }),
  is_synced: integer("is_synced", { mode: "boolean" }).default(false),
...
export const invoices = sqliteTable(
  "invoices",
  {
    ...
    isSubmittedToHmrc: integer("is_submitted_to_hmrc", {
      mode: "boolean",
    }).default(false),
    last_synced_at: integer("last_synced_at", { mode: "timestamp" }),
    is_synced: integer("is_synced", { mode: "boolean" }).default(false),
...
export const income = sqliteTable(
  "income",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    userId: integer("user_id").references(() => users.id),
    businessId: text("business_id").references(
...
export const quarterlySubmissions = sqliteTable(
...
export const appSettings = sqliteTable("app_settings", {
  ...
  mtdReminderEnabled: integer("mtd_reminder_enabled", {
    mode: "boolean",
  }).default(true),
  mtdReminderDays: integer("mtd_reminder_days").default(7),
  autoBackupEnabled: integer("auto_backup_enabled", {
    mode: "boolean",
  }).default(true),
...
export const niContributions = sqliteTable(
  "ni_contributions",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    userId: integer("user_id").references(() => users.id),
...
export const incomeTaxCalculations = sqliteTable(
...
export const paymentsOnAccount = sqliteTable(
  "payments_on_account",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    userId: integer("user_id").references(() => users.id),
