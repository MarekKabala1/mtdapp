...
export const businessDetails = pgTable("business_details", {
  ...
  addressCountryCode: varchar("address_country_code", { length: 2 }).default(
    "GB"
  ),
...
export const invoices = pgTable(
  "invoices",
  {
    ...
    totalAmount: numeric("total_amount", { precision: 10, scale: 2 }).default(
      "0"
    ),
...
export const income = pgTable(
  "income",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id").references(() => users.id),
    businessId: varchar("business_id", { length: 100 }).references(
...
export const quarterlySubmissions = pgTable(
  "quarterly_submissions",
  {
    ...
    totalIncome: numeric("total_income", { precision: 10, scale: 2 }).default(
      "0"
    ),
  ...
  table => [
    uniqueIndex("uniqueSubmission").on(
      table.userId,
      table.businessId,
      table.taxYear,
      table.quarter
...
export const niContributions = pgTable(
  "ni_contributions",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id").references(() => users.id),
    ...
    taxYear: varchar("tax_year", { length: 10 }),
    quarter: integer("quarter"),
    quarterlyProfit: numeric("quarterly_profit", {
      precision: 10,
      scale: 2,
    }).default("0"),
    annualProfitEstimate: numeric("annual_profit_estimate", {
      precision: 10,
      scale: 2,
    }).default("0"),
    class2WeeksLiable: integer("class2_weeks_liable").default(0),
    class2Rate: numeric("class2_rate", { precision: 5, scale: 2 }).default(
      "3.45"
    ),
    class2Due: numeric("class2_due", { precision: 10, scale: 2 }).default("0"),
    class4ProfitBand1: numeric("class4_profit_band1", {
      precision: 10,
      scale: 2,
    }).default("0"),
    class4ProfitBand2: numeric("class4_profit_band2", {
      precision: 10,
      scale: 2,
    }).default("0"),
    class4RateBand1: numeric("class4_rate_band1", {
      precision: 5,
      scale: 2,
    }).default("9.0"),
    class4RateBand2: numeric("class4_rate_band2", {
      precision: 5,
      scale: 2,
    }).default("2.0"),
    class4Due: numeric("class4_due", { precision: 10, scale: 2 }).default("0"),
    totalNiDue: numeric("total_ni_due", { precision: 10, scale: 2 }).default(
      "0"
    ),
  ...
  table => [
    uniqueIndex("uniqueNiContribution").on(
      table.userId,
      table.businessId,
      table.taxYear,
      table.quarter
...
export const incomeTaxCalculations = pgTable(
  "income_tax_calculations",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id").references(() => users.id),
    businessId: varchar("business_id", { length: 100 }).references(
    ...
    totalAllowableExpenses: numeric("total_allowable_expenses", {
      precision: 10,
      scale: 2,
    }).default("0"),
    taxableProfit: numeric("taxable_profit", {
      precision: 10,
      scale: 2,
    }).default("0"),
    ...
    basicRateIncome: numeric("basic_rate_income", {
      precision: 10,
      scale: 2,
    }).default("0"),
    higherRateIncome: numeric("higher_rate_income", {
      precision: 10,
      scale: 2,
    }).default("0"),
    additionalRateIncome: numeric("additional_rate_income", {
      precision: 10,
      scale: 2,
    }).default("0"),
    basicRateTax: numeric("basic_rate_tax", {
      precision: 10,
      scale: 2,
    }).default("0"),
    higherRateTax: numeric("higher_rate_tax", {
      precision: 10,
      scale: 2,
    }).default("0"),
    additionalRateTax: numeric("additional_rate_tax", {
      precision: 10,
      scale: 2,
    }).default("0"),
    totalIncomeTaxDue: numeric("total_income_tax_due", {
      precision: 10,
      scale: 2,
    }).default("0"),
    amountPaid: numeric("amount_paid", { precision: 10, scale: 2 }).default(
  ...
  table => [
    uniqueIndex("uniqueIncomeTax").on(
      table.userId,
      table.businessId,
      table.taxYear,
      table.quarter
...
export const paymentsOnAccount = pgTable(
  "payments_on_account",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id").references(() => users.id),
    ...
    previousYearTaxBill: numeric("previous_year_tax_bill", {
      precision: 10,
      scale: 2,
    }).default("0"),
  ...
  table => [
    uniqueIndex("uniquePaymentOnAccount").on(
      table.userId,
      table.businessId,
      table.taxYear,
      table.paymentNumber
...
export const taxRates = pgTable("tax_rates", {
  ...
  basicRateThreshold: numeric("basic_rate_threshold", {
    precision: 10,
    scale: 2,
  }),
  higherRateThreshold: numeric("higher_rate_threshold", {
    precision: 10,
    scale: 2,
  }),
  basicRatePercentage: numeric("basic_rate_percentage", {
    precision: 5,
    scale: 2,
  }),
  higherRatePercentage: numeric("higher_rate_percentage", {
    precision: 5,
    scale: 2,
  }),
  additionalRatePercentage: numeric("additional_rate_percentage", {
    precision: 5,
    scale: 2,
  }),
  class2WeeklyRate: numeric("class2_weekly_rate", { precision: 5, scale: 2 }),
  class2SmallProfitsThreshold: numeric("class2_small_profits_threshold", {
    precision: 10,
    scale: 2,
  }),
  class4LowerThreshold: numeric("class4_lower_threshold", {
    precision: 10,
    scale: 2,
  }),
  class4UpperThreshold: numeric("class4_upper_threshold", {
    precision: 10,
    scale: 2,
  }),
  ...
  vatStandardRate: numeric("vat_standard_rate", {
    precision: 5,
    scale: 2,
  }).default("20"),
  vatRegistrationThreshold: numeric("vat_registration_threshold", {
    precision: 10,
    scale: 2,
  }).default("85000"),
